...
public sealed class MainWindow : Window
{
    ...
    private void RenderDetail()
    {
        ...
        if (d is null || d.State == AccessState.Unknown)
        {
            ...
            foreach (var pair in new[] { ("WhatWeKnow", AccessSummary.UnknownKnown(resource)), ("CouldNotVerify", AccessSummary.UnknownReason(resource)), ("WhyItMatters", "UnknownMeaning"), ("NextStep", AccessSummary.UnknownNextStep(resource)) })
