...
[${t.download}](${repo}/releases/latest) · [${n.checksums}](${repo}/releases/latest/download/SHA256SUMS.txt) · [${t.status}](${repo}/blob/main/docs/release-status.md)
...
- [${n.handbooks}](${repo}/tree/main/docs/handbooks)
...
- [${n.governance}](${repo}/blob/main/GOVERNANCE.md)
- [${n.support}](${repo}/blob/main/SUPPORT.md)
- [${n.citation}](${repo}/blob/main/CITATION.cff)
...
[${n.development}](${repo}/blob/main/docs/development.md) · [${n.benchmarks}](${repo}/blob/main/docs/benchmarks.md) · [${n.roadmap}](${repo}/blob/main/ROADMAP.md)
